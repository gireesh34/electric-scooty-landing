            ...
            {specifications.map((spec, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div 
                    className="absolute bg-white dark:bg-gray-900 p-2 sm:p-3 rounded-lg shadow-lg min-w-[120px] sm:min-w-[150px] -translate-x-[calc(100%+20px)] -top-[20px] data-[position=right]:translate-x-[calc(100%+20px)] data-[position=right]:right-0"
